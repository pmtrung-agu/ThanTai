...
@section('css')
	<link href="{{ env('APP_URL') }}assets/backend/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
@endsection
@section('body')
<div class="row">
	<div class="col-12">
		<div class="card-box">
			<h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/market-price" class="btn btn-info"><i class="mdi mdi-reply-all"></i></a> Thêm giá cả thị trường</h3>
			<form action="{{ env('APP_URL') }}admin/market-price/create" method="post" id="dinhkemform" enctype="multipart/form-data">
				{{ csrf_field() }}
          	<div class="form-body">
	            <hr />
	            @if($errors->any())
	             	...
	             	<div class="col-md-12">
	                  	<div class="form-group row">
	                     	<label class="control-label col-md-2 text-right p-t-10">Title</label>
	                      	<div class="col-md-10">
	                        	<input type="text" id="title" name="title" class="form-control" placeholder="Tên" value="{{ old('title') }}" required />
	                      	</div>
	                  	</div>
	              	</div>
	            </div>
	                  	...
	                  	<div class="form-group row">
	                     	<label class="control-label col-md-2 text-right p-t-10">Từ ngày</label>
	                      	<div class="col-md-4 input-group">
	                        	<input type="text" id="tungay" name="tungay" class="ngaythangnam form-control" placeholder="Từ ngày" value="{{ old('tungay') }}" required />
	                      	...
	                      	<div class="col-md-4 input-group">
	                        	<input type="text" id="denngay" name="denngay" class="ngaythangnam form-control" placeholder="Đến ngày" value="{{ old('denngay') }}" required />
	                        	<div class="input-group-append">
	                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
	                            </div>
	                      	</div>
            ...
            <div class="form-actions">
                <a href="{{ env('APP_URL') }}admin/market-price" class="btn btn-light"><i class="fa fa-reply-all"></i> Trở về</a>
...
@endsection
@section('js')
	<script src="{{ env('APP_URL') }}assets/backend/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
	...
	<script type="text/javascript">
       $(document).ready(function() {
        ...
        $("#progressbar").hide();
        jQuery('.ngaythangnam').datepicker({
	        format: "dd/mm/yyyy",
	    });
      });
  </script>
