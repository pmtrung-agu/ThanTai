...
<div class="row">
	<div class="col-12">
		<div class="card-box">
			<h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/market-price" class="btn btn-info"><i class="mdi mdi-reply-all"></i></a> Chỉnh sửa giá cả thị trường</h3>
			<form action="{{ env('APP_URL') }}admin/market-price/update" method="post" id="dinhkemform" enctype="multipart/form-data">
			{{ csrf_field() }}
	                  	...
	                  	<div class="form-group row">
	                     	<label class="control-label col-md-2 text-right p-t-10">Từ ngày</label>
	                      	<div class="col-md-4 input-group">
	                        	<input type="text" id="tungay" name="tungay" class="ngaythangnam form-control" placeholder="Từ ngày" value="{{ old('tungay') != null ? old('tungay') : $mp['tungay'] }}" required />
	                      	...
	                      	<div class="col-md-4 input-group">
	                        	<input type="text" id="denngay" name="denngay" class="ngaythangnam form-control" placeholder="Đến ngày" value="{{ old('denngay') != null ? old('denngay') : $mp['denngay']}}" required />
	                        	<div class="input-group-append">
	                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
	                            </div>
	                      	</div>
