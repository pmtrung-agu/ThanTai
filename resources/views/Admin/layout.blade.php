...
<html>
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="topbar-left">
                        <a href="{{ env('APP_URL') }}/admin" class="logo">
                            ...
                            <i>
                                <img src="{{ env('APP_URL') }}assets/backend/images/logo_sm.png" alt="" height="28">
                            </i>
                        </a>
                    </div>
                    <!--- Sidemenu -->
                    <div id="sidebar-menu" style="margin-top:70px;">
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li><a href="{{ env('APP_URL') }}" target="_blank"><i class="mdi mdi-earth"></i> <span> Xem trang </span></span></a></li>
                            <li><a href="{{ env('APP_URL') }}admin/dashboard"><i class="fi-air-play"></i> <span> Dashboard </span></span></a></li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ env('APP_URL') }}admin/address">Địa chỉ</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/product-category">Danh mục sản phẩm</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/mail-list">Email</a></li>
                                </ul>
                            </li>
                            {{-- <li>
                                <a href="javascript: void(0);"><i class="mdi mdi-brightness-5"></i> <span> Tin tức </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ env('APP_URL') }}admin/category">Danh mục tin tức</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/article">Tất cả tin tức</a></li>
                                </ul>
                            </li> --}}
                            <li>
                                <a href="javascript: void(0);"><i class="fa fa-user-circle-o"></i> <span> Khách hàng</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ env('APP_URL') }}admin/customer">Tất cả</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/customer/1">Hoạt động</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/customer/0">Tạm ngưng hoạt động</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="mdi mdi-account-card-details"></i> <span> Doanh nghiệp</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ env('APP_URL') }}admin/seller">Tất cả</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/seller/1">Hoạt động</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/seller/0">Tạm ngưng hoạt động</a></li>
                                </ul>
                            </li>
                            @endif
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ env('APP_URL') }}admin/product">Tất cả</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/product/1">Hoạt động</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/product/0">Tạm ngưng</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ env('APP_URL') }}admin/promotion"><i class="fa fa-opencart"></i> <span> Khuyến mãi</span></a></li>
                            <li>
                                <a href="javascript: void(0);"><i class="mdi mdi-cart"></i> <span> Đơn hàng</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ env('APP_URL') }}admin/order">Tất cả</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/order/0">Đơn hàng chờ xử lý</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/order/1">Đơn hàng Hoàn thành</a></li>
                                    <li><a href="{{ env('APP_URL') }}admin/order/2">Đơn hàng Hủy</a></li>
                                </ul>
                            </li>
                            {{-- <li><a href="{{ env('APP_URL') }}admin/market-price"><i class="mdi mdi-basket"></i> <span> Giá cả thị trường</span></a></li>
                            <li><a href="{{ env('APP_URL') }}admin/logistic"><i class="fa fa-truck"></i> <span> Hạ tầng Logistics </span></a></li>
                            <li><a href="{{ env('APP_URL') }}admin/shopping"><i class="fa fa-shopping-basket"></i> <span> Shopping </span></a></li> --}}
                            @if(in_array('Admin', Session::get('user.roles')))
                            <li>
                    ...
                    <nav class="navbar-custom">
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            <li class="hide-phone app-search">
                                <form action="{{ env('APP_URL') }}admin/search" method="GET">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ env('APP_URL') }}assets/backend/images/logo_sm.png" alt="user" class="rounded-circle"> <span class="ml-1">{{Session::get('user.email')}}<i class="mdi mdi-chevron-down"></i> </span>
                                </a>
    ...
    <!-- ============================================================== -->
        ...
        <!-- App js -->
        {{--  <script src="{{ env('APP_URL') }}assets/js/jquery.core.js"></script>--}}
