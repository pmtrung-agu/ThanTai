...
<div class="row">
	<div class="col-12">
		<div class="card-box">
			<h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/logistic" class="btn btn-info"><i class="mdi mdi-reply-all"></i></a> Thêm Hạ tầng Thương mại biên giới và hệ thống dịch vụ Logistic</h3>
			<form action="{{ env('APP_URL') }}admin/logistic/create" method="post" id="dinhkemform" enctype="multipart/form-data">
				{{ csrf_field() }}
          	<div class="form-body">
	            <hr />
	            @if($errors->any())
