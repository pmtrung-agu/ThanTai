...
<div class="row">
    <div class="col-12">
        <div class="card-box">
          <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/customer" class="btn btn-primary"><i class="mdi mdi-reply-all"></i></a> Chỉnh sửa tài khoản Khách hàng</h3>
                <form action="{{ env('APP_URL') }}admin/customer/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                  {{ csrf_field() }}
