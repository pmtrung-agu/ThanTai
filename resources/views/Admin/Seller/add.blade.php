...
<div class="row">
  <div class="col-12">
    <div class="card-box">
      <h3 class="m-t-0"><a href="{{ env('APP_URL') }}admin/seller" class="btn btn-primary"><i class="mdi mdi-reply-all"></i></a> Thêm tài khoản Doanh nghiệp</h3>
      <form action="{{ env('APP_URL') }}admin/seller/create" method="post" id="dinhkemform" enctype="multipart/form-data">
        {{ csrf_field() }}
          <div class="form-body">
              <hr>
              @if($errors->any())
