    ...
    <div class="container">
      <div id="thm_slider_wrapper" class="thm_slider_wrapper fullwidthbanner-container">
        <div id='thm-rev-slider' class='rev_slider fullwidthabanner'>
          <ul>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_0.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_0.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_1.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_1.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_2.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_2.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            {{-- <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_3.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_3.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_4.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_4.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_5.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_5.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_6.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_6.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='{{ env('APP_URL') }}assets/frontend/images/banner/slide_7.jpg'><img src='{{ env('APP_URL') }}assets/frontend/images/banner/slide_7.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li> --}}
          </ul>
        </div>
      </div>
          ...
          <div class="slider-items-products">
              <div class="new_title" style="padding:0px !important;">
                  <h2 style="background:#ffd728;padding:7px 20px 7px 20px;">
                    <a href="{{ env('APP_URL') }}flash-sale"><img src="{{ env('APP_URL') }}assets/frontend/images/flash_sale.png" style="height:50px;padding:0px;">
                        ...
                        <div class="item">
                            <a href="{{ env('APP_URL') }}chi-tiet-san-pham/{{ $ph['slug'] }}">
                                <div class="pro-img">
                                  ...
                                  @else
                                    <img src="{{ env('APP_URL') }}assets/frontend/products-images/p1.jpg" alt="{{ $ph['title'] }}">
                                  @endif
          ...
          <div class="slider-items-products">
              <div class="new_title" style="padding:0px !important;">
                  <h2 style="background:#ffd728;padding:7px 20px 7px 20px;font-weight: bold !important;">
                    <a href="{{ env('APP_URL') }}flash-sale-soon"><img src="{{ env('APP_URL') }}assets/frontend/images/flash_sale.png" style="height:50px;padding:0px;">
      ...
      <div class="blog_inner">
          <div class="blog-img">
              <a href="{{ env('APP_URL') }}chi-tiet-tin-tuc/{{ $article['slug'] }}">
                ...
                @else
                  <img src="{{ env('APP_URL') }}assets/frontend/images/default_875x476.jpg" alt="{{ $article['title'] }}">
                @endif
              </a>
              <div class="mask">
...
{{--  <div id="modalPopup" class="modal fade" role="dialog" aria-hidden="true"  style="background:none;">
  <div class="modal-dialog modal-lg"  style="background:#ccc;width:80%;max-width: 600px;-webkit-box-shadow: 0px 0px 15px 5px rgba(69,179,99,1);-moz-box-shadow: 0px 0px 15px 5px rgba(69,179,99,1);box-shadow: 0px 0px 15px 5px rgba(69,179,99,1);">
    ...
    <a href="{{ env('APP_URL') }}flash-sale">
      <img src="{{ env('APP_URL') }}assets/frontend/images/popup_flash_sale.jpg" style="width:100%"/>
    </a>
  </div>
</div>--}}
