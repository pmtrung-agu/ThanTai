...
<title>Chiếu UZU Tân Châu Long @yield('title')</title>
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<meta name="description" content="Chiếu UZU Tân Châu Long">
<meta name="keywords" content="Chiếu UZU Tân Châu Long">
...
<div id="left_banner_1">
  <a href="{{ env('APP_URL') }}gia-ca-thi-truong">
    <img src="{{ env('APP_URL') }}assets/frontend/images/left_banner_1.jpg" alt="" />
  </a>
</div>
<div id="left_banner_2">
  <a href="{{ env('APP_URL') }}diem-mua-sam-dat-chuan">
    <img src="{{ env('APP_URL') }}assets/frontend/images/left_banner_2.jpg" alt="" />
  </a>
</div>
<div id="right_banner">
  <a href="{{ env('APP_URL') }}logistic">
    <img src="{{ env('APP_URL') }}assets/frontend/images/right_banner.jpg" alt="" />
  </a>
</div>
<div id="page">
 <header>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div style="height: 20px; overflow: hidden;" id="slideshow">
            <p style="display: block;">Chiếu UZU Tân Châu Long - <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> chieuuzu@gmail.com <span class="glyphicon glyphicon-phone"></span> 0914 377808</p>
            <p style="display: none;">Chiếu UZU Tân Châu Long  - <span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> chieuuzu@gmail.com <span class="glyphicon glyphicon-phone"></span>0914 377808</p>
          </div>
        </div>
      </div>
     </div>
    ...
    <div class="header-container container">
     <div class="row">
      <div class="logo"> <a href="{{ env('APP_URL') }}" title="Sản phẩm An Giang">
        <div><img src="{{ env('APP_URL') }}assets/frontend/images/logo.png" alt="Sản phẩm An Giang"></div>
        </a> </div>
  ...
  <div class="content">
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-xs-12 coppyright">© 2024 Chiếu UZU Tân Châu Long <br />Địa chỉ: 66 An Hưng, thị trấn An Phú, huyện An Phú, tỉnh An Giang</div>
        </div>
        <!--row-->
      </div>
      <!--container-->
