        ...
        @if($promotions)
          <div class="toolbar" style="border:none !important;padding:0px 0px 10px 0px;">
            ...
            @foreach($flash_sale_soon as $soon)
              <span class="flash-sale-soon @if($soon->milliseconds == $date_from) active @endif">
                  ...
                  <ul class="products-grid">
                    ...
                    @foreach($pro['id_products'] as $key => $value)
                    	@php
                          ...
                          $date_from = App\Http\Controllers\ObjectController::getDate($pro['date_from'], "d/m/Y H:i");
	                        ...
	                        <div class="item-inner">
	                           <div class="item-img">
	                              <div class="item-img-info">
	                                 ...
	                                 <div class="new-label sale-time-label new-top-left" data-time="{{ $date_from }}" style="width:120px;">{{ $date_from }}</div>
               ...
               <div class="toolbar">
                  <div class="pager" style="width:100%;">
                     <div class="pages">
                      ...
                      @endphp
                      @if($query)
                        {{ $promotions->withPath(env('APP_URL').'flash-sale-soon/?'.$query) }}
                      @else
                        {{ $promotions->withPath(env('APP_URL').'flash-sale-soon') }}
                      @endif
                     </div>
                  </div>
               </div>
