...
<link rel="icon" href="{{ env('APP_URL') }}assets/frontend/uzu/images/logo.png" type="image/x-icon">
<link rel="shortcut icon" href="{{ env('APP_URL') }}assets/frontend/uzu/images/logo.png" type="image/x-icon">
...
<!-- CSS Style -->
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/font-awesome.css" media="all">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/revslider.css" >
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/owl.theme.css">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/jquery.bxslider.css">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/jquery.mobile-menu.css">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/style.css" media="all">
<link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}assets/frontend/uzu/css/responsive.css" media="all">
...
<div id="left_banner_1">
  <a href="{{ env('APP_URL') }}gia-ca-thi-truong">
    <img src="{{ env('APP_URL') }}assets/frontend/uzu/images/left_banner_1.jpg" alt="" />
  </a>
</div>
<div id="left_banner_2">
  <a href="{{ env('APP_URL') }}diem-mua-sam-dat-chuan">
    <img src="{{ env('APP_URL') }}assets/frontend/uzu/images/left_banner_2.jpg" alt="" />
  </a>
</div>
<div id="right_banner">
  <a href="{{ env('APP_URL') }}logistic">
    <img src="{{ env('APP_URL') }}assets/frontend/uzu/images/right_banner.jpg" alt="" />
  </a>
</div>
<div id="page">
 <header>
  ...
  <div id="header">
    <div class="header-container container">
     <div class="row">
      <div class="logo"> <a href="{{ env('APP_URL') }}" title="Sản phẩm An Giang">
        <div><img src="{{ env('APP_URL') }}assets/frontend/uzu/images/logo.png" alt="Sản phẩm An Giang"></div>
        </a> </div>
                ...
                <li class="item_{{ $p['_id'] }} item">
                  <div class="item-inner">
                    <a class="product-image" title="{{ $p['title'] }}" href="#">
                      ...
                      @else
                        <img alt="{{ $p['title'] }}" src="{{ env('APP_URL')}}assets/frontend/uzu/products-images/p4.jpg">
                      @endif
                    </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-4 col-xs-12 col-lg-4">
                    <div class="co-info">
                        <div>
                            <a href="index.html"><img src="{{ env('APP_URL') }}assets/frontend/uzu/images/logo.png" alt="footer logo"></a>
                        </div>
                        <address>
...
<!-- JavaScript -->
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/jquery.min.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/bootstrap.min.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/parallax.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/revslider.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/common.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/jquery.bxslider.min.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/jquery.flexslider.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/owl.carousel.min.js"></script>
<script type="text/javascript" src="{{ env('APP_URL') }}assets/frontend/uzu/js/jquery.mobile-menu.min.js"></script>
