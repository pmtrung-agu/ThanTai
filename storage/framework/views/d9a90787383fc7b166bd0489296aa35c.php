    ...
    <div class="container">
      <div id="thm_slider_wrapper" class="thm_slider_wrapper fullwidthbanner-container">
        <div id='thm-rev-slider' class='rev_slider fullwidthabanner'>
          <ul>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/banner/slide_0.jpg'><img src='<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/banner/slide_0.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/banner/slide_1.jpg'><img src='<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/banner/slide_1.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/banner/slide_2.jpg'><img src='<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/banner/slide_2.jpg'  data-bgposition='center center'  data-bgfit='cover' data-bgrepeat='no-repeat'/>
            </li>
          ...
          <div class="slider-items-products">
              <div class="new_title" style="padding:0px !important;">
                  <h2 style="background:#ffd728;padding:7px 20px 7px 20px;">
                    <a href="<?php echo e(env('APP_URL')); ?>flash-sale"><img src="<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/flash_sale.png" style="height:50px;padding:0px;">
                        ...
                        <div class="item">
                            <a href="<?php echo e(env('APP_URL')); ?>chi-tiet-san-pham/<?php echo e($ph['slug']); ?>">
                                <div class="pro-img">
                                  ...
                                  <?php else: ?>
                                    <img src="<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/products-images/p1.jpg" alt="<?php echo e($ph['title']); ?>">
                                  <?php endif; ?>
          ...
          <div class="slider-items-products">
              <div class="new_title" style="padding:0px !important;">
                  <h2 style="background:#ffd728;padding:7px 20px 7px 20px;font-weight: bold !important;">
                    <a href="<?php echo e(env('APP_URL')); ?>flash-sale-soon"><img src="<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/images/flash_sale.png" style="height:50px;padding:0px;">
                            ...
                            <div class="item-img">
                                <div class="item-img-info">
                                    <a href="<?php echo e(env('APP_URL')); ?>chi-tiet-san-pham/<?php echo e($p['slug']); ?>" title="<?php echo e($p['title']); ?>" class="product-image">
                                      ...
                                      <?php else: ?>
                                        <img src="<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/products-images/p1.jpg" alt="<?php echo e($p['title']); ?>">
                                      <?php endif; ?>
                                      </a>
...
<script type="text/javascript" src="<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/plugins/jquery.countdown/jquery.countdown.min.js"></script>
<script type="text/javascript" src="<?php echo e(env('APP_URL')); ?>assets/frontend/uzu/js/script.js"></script>
...
<?php echo $__env->make('Frontend.Uzu.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ThanTai\resources\views/Frontend/Uzu/index.blade.php ENDPATH**/ ?>