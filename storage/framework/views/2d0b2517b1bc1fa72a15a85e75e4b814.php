...
<div class="row">
	<div class="col-12">
    	<div class="card-box table-responsive">
    		<h3 class="m-t-0"><a href="<?php echo e(env('APP_URL')); ?>admin/product" class="btn btn-info"><i class="mdi mdi-reply-all"></i></a> Thêm sản phẩm</h3>
    		<form action="<?php echo e(env('APP_URL')); ?>admin/product/create" method="post" id="dinhkemform" enctype="multipart/form-data">
                          ...
                          <select name="id_product_category[]" multiple="multiple" id="id_product_category" class="form-control select2" required data-placeholder="Chọn loại sản phẩm">
                            ...
                            <?php if($product_categories): ?>
                              <?php $__currentLoopData = $product_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat['_id']); ?>"><?php echo e($cat['title']); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                          </select>
                      </div>
                      ...
                      <select name="id_seller" id="id_seller" class="form-control select2">
                        <?php if($sellers): ?>
                          <?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($seller['_id']); ?>" <?php if($seller['_id'] == $id_user): ?> selected <?php endif; ?>><?php echo e($seller['email']); ?> [<?php echo e($seller['name']); ?>]</option>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                      </select>
                    </div>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ChieuUZU\resources\views/Admin/Product/add.blade.php ENDPATH**/ ?>