...
<div class="row">
  <div class="col-12">
    <div class="card-box">
      <h3 class="m-t-0"><a href="<?php echo e(env('APP_URL')); ?>admin/seller" class="btn btn-primary"><i class="mdi mdi-reply-all"></i></a> Thêm tài khoản Doanh nghiệp</h3>
      <form action="<?php echo e(env('APP_URL')); ?>admin/seller/create" method="post" id="dinhkemform" enctype="multipart/form-data">
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Lara_Projects\ChieuUZU\resources\views/Admin/Seller/add.blade.php ENDPATH**/ ?>